...
?>
	...
	<a href="blog-details.html"><img class="img-responsive" src="<?php the_post_thumbnail_url( array(500, 300) );?>" alt=""></a>
	<h1><a href="<?php the_permalink();?>"><?php the_title();?></a></h1>
	<span class="author"><?php the_author();?></span>
	<span class="review"><?php comments_number( $zero, $one, $more ); ?>  </span>
	<span class="date-time"><?php the_time('Y/m/d \a\t g:i A ') ?></span>
	<p><?php the_excerpt();?></p>
